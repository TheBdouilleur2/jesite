...
<section>
  <form action="chat_post.php" method="POST">
    ...
    <input type='submit', name='msg_envoie_admin'/></p>
  </form>
  ...
  $req_msg = $bdd->query('SELECT * FROM chat_admin ORDER BY date_publication DESC LIMIT 0,20');
